...
class ExportImportDatabaseCLI
{
    ...
    function __construct($options = []){
        ...
        if (isset($config['import'])) {
            $this->options['import'] = array_merge($this->options['import'], $config['import']);
        }
...
$eidb = new ExportImportDatabaseCLI();
if (!method_exists($eidb, $action)) {
